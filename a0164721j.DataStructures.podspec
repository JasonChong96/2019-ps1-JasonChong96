...
BreadthFirstTraversal and DepthFirstTraversal generators for Dictionaries."
  ...
  s.author             = { "JasonChong96" => "jasontjakra@gmail.com" }
  # Or just: s.author    = "JasonChong96"
  # s.authors            = { "JasonChong96" => "jasontjakra@gmail.com" }
  # s.social_media_url   = "http://twitter.com/JasonChong96"
  ...
  s.exclude_files = "DataStructures/AppDelegate.swift", "*ViewController*"
